    ...
    <Head>
      ...
      <nav className={`fixed top-0 left-0 right-0 z-40 transition-all duration-300 ${scrolled ? 'nav-blur' : ''}`}
        ...
        <button onClick={() => router.push('/')}
          ...
          <img src="data:image/png;base64," width="20" height="24" alt="Regly" style={{display:"inline-block",verticalAlign:"middle"}}/><span style={{fontFamily:"'Playfair Display',Georgia,serif",fontWeight:700,fontStyle:'italic',fontSize:20,color:'#1A0A06',letterSpacing:'-0.01em'}}>Regly</span>
        </button>
          ...
          <div style={{display:'grid', gridTemplateColumns: isMobile ? '1fr 1fr' : '2fr 1fr 1fr 1fr', gap: isMobile ? '40px 24px' : '48px 32px', marginBottom: isMobile ? 48 : 64}}>
            <div>
              <p style={{fontFamily:'Georgia, serif', fontSize:22, fontWeight:700, color:'#F5F0E8', marginBottom:12}}>
                <img src="data:image/png;base64," width="16" height="19" alt="Regly" style={{display:"inline-block",verticalAlign:"middle"}}/><span style={{fontFamily:"'Playfair Display',Georgia,serif",fontWeight:700,fontStyle:'italic',letterSpacing:'-0.01em'}}>Regly</span>
              </p>
