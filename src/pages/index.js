          ...
          <div style={{display:'grid', gridTemplateColumns: isMobile ? '1fr 1fr' : '2fr 1fr 1fr 1fr', gap: isMobile ? '40px 24px' : '48px 32px', marginBottom: isMobile ? 48 : 64}}>
            <div>
              <p style={{fontFamily:'Georgia, serif', fontSize:22, fontWeight:700, color:'#F5F0E8', marginBottom:12}}>
                <svg width="16" height="19" viewBox="0 0 110 132" fill="none" style={{display:'inline-block',verticalAlign:'middle',marginRight:6}}><path d="M55 3C27 3 5 25 5 53C5 81 55 129 55 129C55 129 105 81 105 53C105 25 83 3 55 3Z" fill="#C0442B"/><path d="M38 76L38 22Q58 22 58 22Q78 22 78 38Q78 54 58 54L38 54M56 54L80 76" stroke="#F5F0E8" strokeWidth="9" strokeLinecap="round" strokeLinejoin="round" fill="none"/></svg><span style={{fontFamily:"'Playfair Display',Georgia,serif",fontWeight:700,fontStyle:'italic',letterSpacing:'-0.01em'}}>Regly</span>
              </p>
