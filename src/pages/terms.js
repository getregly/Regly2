    ...
    <div style={{minHeight:'100vh', background:'#F9FAFB', fontFamily:"'Inter', system-ui, sans-serif"}}>
      ...
      <div style={{maxWidth:800, margin:'0 auto', padding:'48px 24px 80px'}}>
        <div style={{marginBottom:40}}>
          ...
          <h1 style={{fontFamily:'Georgia, serif', fontSize:32, fontWeight:700, color:'#1A0A06', marginBottom:8}}>Customer Terms of Service</h1>
...
getregly.com`
        ...
        <div style={{marginBottom:32, padding:'20px 24px', background:'white', borderRadius:12, boxShadow:'0 1px 6px rgba(0,0,0,0.05)'}}>
          <p style={{fontSize:13, color:'#9CA3AF', margin:0}}>
            ...
            <a href="/merchant-terms" target="_blank" style={{color:'#C0442B', fontWeight:500, textDecoration:'none'}}>
