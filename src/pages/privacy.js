        ...
        {[
          {
            ...
            body:`Regly ("we," "us," or "our") operates the membership platform at getregly.com. If you have any questions about this policy, contact us at getregly@gmail.com.`
          },
          {
...
getregly.com`
        ...
        <div style={{textAlign:'center', paddingTop:32, borderTop:'1px solid #F3F4F6'}}>
          <p style={{color:'#8A7A6A', fontSize:13}}>
